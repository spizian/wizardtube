...
namespace spizian\wizardtube;

use spizian\wizardtube\Middleware\InstallerMiddleware;
use spizian\wizardtube\Middleware\ToInstallMiddleware;
use Illuminate\Contracts\Http\Kernel;
use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;

class wizardtubeServiceProvider extends ServiceProvider
{
